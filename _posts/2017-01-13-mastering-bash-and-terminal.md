...
<!-- ![disown](https://blockloop.nyc3.digitaloceanspaces.com/images/Blog/mastering-bash-and-terminal/disown.gif) -->

```bash
bjones@brettslaptop:~/tmp
$ kubectl proxy
Starting to serve on 127.0.0.1:8001^z
[1]+ Stopped             kubectl proxy
bjones@brettslaptop:~/tmp 1
$ bg
[1]+ kubectl proxy &
bjones@brettslaptop:~/tmp 1
$ jobs -l
...
<!-- ![jobs-count-ss](https://blockloop.nyc3.digitaloceanspaces.com/images/Blog/mastering-bash-and-terminal/jobs-count-ss.png) -->

```bash
bjones@brettslaptop:~/tmp 1 #<--- here
$ 
```
